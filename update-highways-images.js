...
/**
 * Update Highways website HTML files to use AVIF → WebP → JPEG fallback strategy
 * 
 * This script processes all HTML files in the Highways website and converts
 ...
 */
function main() {
    console.log('🚀 Highways Website Image Optimization');
    console.log('=====================================');
