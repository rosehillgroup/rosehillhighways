...
/**
 * Test script to verify Highways website image optimization is working correctly
 */

function testImageOptimization() {
    console.log('🧪 Testing Highways Website Image Optimization');
    console.log('=============================================');
    ...
    const testFiles = [
        'highways_ncld_edinburgh.avif',
        'highways_ncld_edinburgh.webp',
        'speed_cushion_web.avif',
        'speed_cushion_web.webp',
        'traffic_island_web.avif',
        'traffic_island_web.webp',
        'raised_table_web.avif',
        'raised_table_web.webp'
    ];
